                ...
                <React.Fragment key={Math.random()}>
                  <div className="bg-white_A700 flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-end p-[79px] sm:px-[20px] md:px-[40px] rounded-radius15">
                    ...
                    <div className="flex flex-col items-center justify-start md:ml-[0] sm:ml-[0] ml-[80px] pb-[5px] md:w-[100%] sm:w-[100%] w-[42%]">
                      ...
                      <div className="flex flex-row items-start justify-center mt-[28px] md:w-[100%] sm:w-[100%] w-[69%]">
                        <div className="bg-gray_700 h-[1px] my-[7px] w-[8%]"></div>
                        <Text
                          className="font-normal ml-[11px] not-italic text-gray_700 text-left w-[auto]"
                          variant="body5"
                        >
                          Or sign in with your email
                        </Text>
                        <div className="bg-gray_700 h-[1px] ml-[10px] my-[7px] w-[8%]"></div>
                      </div>
                      <div className="flex flex-col items-center justify-start mt-[25px] w-[100%]">
                        <div className="flex flex-col gap-[28px] items-center justify-start pt-[7px] w-[100%]">
                        ...
                        <Button
                          className="common-pointer cursor-pointer font-medium mt-[30px] text-[16px] text-center text-white_A700 w-[100%]"
                          onClick={() => navigate("/home1")}
                          size="lg"
                        >
                          Sign In
                        </Button>
                        <div className="flex flex-row items-end justify-between mt-[24px] py-[3px] w-[100%]">
                          <div className="flex flex-row gap-[10px] items-end justify-start w-[48%]">
                            <Img
                            ...
                            />
                            <Text
                              className="flex-grow font-normal mb-[2px] mt-[5px] not-italic text-gray_700 text-left"
                              variant="body5"
                            >
                              Keep me signed in
                            </Text>
                          ...
                          <Text
                            className="font-normal mb-[2px] mt-[5px] not-italic text-gray_700 text-left w-[auto]"
                            variant="body5"
                          >
                            Forgot Password?
                          </Text>
                        </div>
                        <div className="flex flex-row gap-[4px] items-start justify-start mt-[31px] md:w-[100%] sm:w-[100%] w-[auto]">
                          <Text
